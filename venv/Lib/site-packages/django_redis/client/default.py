...
class DefaultClient(object):
    def __init__(self, server, params, backend):
        ...
        self._subordinate_read_only = self._options.get('SLAVE_READ_ONLY', True)
    ...
    def get_next_client_index(self, write=True, tried=()):
        ...
        get a next read client for main-subordinate setup.
    ...
    def connect(self, index=0):
        ...
        instance. Index is used for main/subordinate setups and indicates that
    ...
    def set(self, key, value, timeout=DEFAULT_TIMEOUT, version=None, client=None, nx=False, xx=False):
        ...
        while True:
            try:
                ...
                if not original_client and not self._subordinate_read_only and len(tried) < len(self._server):
                    tried.append(index)
                    client = None
                    continue
